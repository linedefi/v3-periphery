# LineHub Dex V3 AMM Periphery Contracts
...
This repository contains the periphery smart contracts for the LineHub Dex V3 AMM Protocol, forked from [uniswap](https://github.com/Uniswap/v3-periphery).
For the lower level core contracts, see the [v3-core]
repository.
